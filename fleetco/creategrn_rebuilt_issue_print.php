...
require_once("include/creategrn_rebuilt_issue_variables.php");
...
$page_layouts["creategrn_rebuilt_issue_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "creategrn-rebuilt-issue" );
