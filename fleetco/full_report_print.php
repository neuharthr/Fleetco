...
require_once("include/full_report_variables.php");
...
$page_layouts["full_report_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "full-report" );
