...
require_once("include/vehiclemaster_full_cost_variables.php");
...
$page_layouts["vehiclemaster_full_cost_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "vehiclemaster-full-cost" );
