...
require_once("include/creategrn_receive_rebuilt_variables.php");
...
$page_layouts["creategrn_receive_rebuilt_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "creategrn-receive-rebuilt" );
