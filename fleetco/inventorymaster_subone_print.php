...
require_once("include/inventorymaster_subone_variables.php");
...
$page_layouts["inventorymaster_subone_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "inventorymaster-subone" );
