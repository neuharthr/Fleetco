...
require_once("include/fuelmaster_reporting_variables.php");
...
$page_layouts["fuelmaster_reporting_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "fuelmaster-reporting" );
