...
require_once("include/vehiclemaster_view_variables.php");
...
$page_layouts["vehiclemaster_view_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "vehiclemaster-view" );
