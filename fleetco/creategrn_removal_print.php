...
require_once("include/creategrn_removal_variables.php");
...
$page_layouts["creategrn_removal_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "creategrn-removal" );
