...
require_once("include/inventorymaster_subonex_variables.php");
...
$page_layouts["inventorymaster_subonex_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "inventorymaster-subonex" );
