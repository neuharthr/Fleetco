...
require_once("include/inventorymaster_subone21_variables.php");
...
$page_layouts["inventorymaster_subone21_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "inventorymaster-subone21" );
