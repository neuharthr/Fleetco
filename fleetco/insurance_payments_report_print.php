...
require_once("include/insurance_payments_report_variables.php");
...
$page_layouts["insurance_payments_report_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "insurance-payments-report" );
