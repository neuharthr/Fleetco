...
require_once("include/fuelmaster_data_variables.php");
...
$page_layouts["fuelmaster_data_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "fuelmaster-data" );
