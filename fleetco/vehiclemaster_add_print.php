...
require_once("include/vehiclemaster_add_variables.php");
...
$page_layouts["vehiclemaster_add_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "vehiclemaster-add" );
