...
require_once("include/creategrn_issue_rebuilt_use_variables.php");
...
$page_layouts["creategrn_issue_rebuilt_use_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "creategrn-issue-rebuilt-use" );
