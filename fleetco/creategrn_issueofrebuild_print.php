...
require_once("include/creategrn_issueofrebuild_variables.php");
...
$page_layouts["creategrn_issueofrebuild_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "creategrn-issueofrebuild" );
