...
require_once("include/fuelmaster_report_variables.php");
...
$page_layouts["fuelmaster_report_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "fuelmaster-report" );
