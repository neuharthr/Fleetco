...
require_once("include/insuranceclaims_report_variables.php");
...
$page_layouts["insuranceclaims_report_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "insuranceclaims-report" );
