...
require_once("include/creategrn1_variables.php");
...
$page_layouts["creategrn1_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "creategrn1" );
