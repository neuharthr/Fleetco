...
require_once("include/inventorymaster_subone211_variables.php");
...
$page_layouts["inventorymaster_subone211_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "inventorymaster-subone211" );
