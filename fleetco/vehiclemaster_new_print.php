...
require_once("include/vehiclemaster_new_variables.php");
...
$page_layouts["vehiclemaster_new_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "vehiclemaster-new" );
