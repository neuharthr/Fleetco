...
require_once("include/inventorymaster_subone2_variables.php");
...
$page_layouts["inventorymaster_subone2_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "inventorymaster-subone2" );
