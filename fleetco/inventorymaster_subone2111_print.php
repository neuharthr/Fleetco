...
require_once("include/inventorymaster_subone2111_variables.php");
...
$page_layouts["inventorymaster_subone2111_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "inventorymaster-subone2111" );
