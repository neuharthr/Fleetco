...
require_once("include/fuelmaster1_variables.php");
...
$page_layouts["fuelmaster1_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "fuelmaster1" );
