...
function DisplayMasterTableInfoForPrint_creategrn($params)
{
	global $cman;
	...
	if( $detailtable == "inventorymaster" )
	{
		...
		$showKeys.= " ".GetFieldLabel("creategrn","ItemCode").": ".$keyValue;
	...
	$layout = GetPageLayout("creategrn", 'masterprint');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');

	$xt->displayPartial(GetTemplateName("creategrn", "masterprint"));
}
