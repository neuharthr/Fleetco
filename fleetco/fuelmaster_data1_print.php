...
require_once("include/fuelmaster_data1_variables.php");
...
$page_layouts["fuelmaster_data1_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "fuelmaster-data1" );
