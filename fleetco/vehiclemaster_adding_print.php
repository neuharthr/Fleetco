...
require_once("include/vehiclemaster_adding_variables.php");
...
$page_layouts["vehiclemaster_adding_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "vehiclemaster-adding" );
