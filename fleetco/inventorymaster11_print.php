...
require_once("include/inventorymaster11_variables.php");
...
$page_layouts["inventorymaster11_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "inventorymaster11" );
