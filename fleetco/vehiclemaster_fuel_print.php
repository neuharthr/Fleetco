...
require_once("include/vehiclemaster_fuel_variables.php");
...
$page_layouts["vehiclemaster_fuel_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "vehiclemaster-fuel" );
