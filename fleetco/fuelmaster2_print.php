...
require_once("include/fuelmaster2_variables.php");
...
$page_layouts["fuelmaster2_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "fuelmaster2" );
