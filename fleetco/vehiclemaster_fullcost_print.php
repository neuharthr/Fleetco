...
require_once("include/vehiclemaster_fullcost_variables.php");
...
$page_layouts["vehiclemaster_fullcost_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "vehiclemaster-fullcost" );
