...
require_once("include/inventorymaster_subone1_variables.php");
...
$page_layouts["inventorymaster_subone1_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "inventorymaster-subone1" );
